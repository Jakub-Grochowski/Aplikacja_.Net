...
namespace SalahProjekt.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    SendMail(model.Email, "Mail Od Kuby z Projektu", "Pozdrawiam Tu Program XD");
                    TheRedsContext db = new TheRedsContext();
        ...
        {
            MailMessage message = new MailMessage(ConfigurationManager.AppSettings["sender"], to)
            {
                Subject = subject,
                Body = body
            };
